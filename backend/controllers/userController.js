...
//DELETE a user, DELETE /api/users/:id, access: private/admin
...
//GET user by id, GET /api/users/:id, access: private/admin
...
//PUT user update, PUT /api/users/:id, access: private/admin
