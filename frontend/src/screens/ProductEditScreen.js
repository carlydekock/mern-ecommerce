...
import { PRODUCT_DETAILS_RESET, PRODUCT_UPDATE_RESET } from '../redux/constants/productContants';
      ...
      <FormContainer>
        ...
        <Form.Group controlId='name' className='my-3'>
          ...
          <Form.Group controlId='image' className='my-3'>
            ...
            <Form.Control type='file' placeholder='Enter image url' onChange={handleFileUpload}></Form.Control>
